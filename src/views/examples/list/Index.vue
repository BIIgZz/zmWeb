  ...
  <page-layout :title="title">
    <a-card :bordered="false">
      <detail-list title="订单详情">
        <detail-list-item term="FBIID">1000000000</detail-list-item>
       ...
       <button type="button"  >打印装车清单</button>
      </detail-list>
      <button type="button"  >打印装车清单</button>
      <a-divider style="margin-bottom: 32px"/>
      <detail-list title="用户信息">
        <detail-list-item term="用户姓名">sdf</detail-list-item>
        <detail-list-item term="联系电话">18100000000</detail-list-item>
        <detail-list-item term="常用快递"> dsf</detail-list-item>
