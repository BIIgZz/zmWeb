  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tree/testShoptypeTree/rootList",
          childList: "/tree/testShoptypeTree/childList",
          getChildListBatch: "/tree/testShoptypeTree/getChildListBatch",
          delete: "/tree/testShoptypeTree/delete",
          deleteBatch: "/tree/testShoptypeTree/deleteBatch",
          exportXlsUrl: "/tree/testShoptypeTree/exportXls",
          importExcelUrl: "tree/testShoptypeTree/importExcel",
        },
        expandedRowKeys:[],
