        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="余额" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="balance">
              <a-input v-model="model.balance"placeholder="请输入余额" ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zmexpress/zmClientMain/addZmClientFinance",
          edit: "/zmexpress/zmClientMain/editZmClientFinance",
        }
